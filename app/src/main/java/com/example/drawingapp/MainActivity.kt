    ...
    val requestPermission: ActivityResultLauncher<Array<String>> =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
            ...
            permissions.entries.forEach{
                ...
                if(isGranted){
                    Toast.makeText(this,"Permission granted, You can read the Storage Files"
    ...
    private fun requestStoragePermission(){
            ...
            Manifest.permission.READ_EXTERNAL_STORAGE))
        {
            showRationaleDialog("Kids Drawing App",
                "Kids Drawing App Needs to Access Your External Gallery")
        }else{
            ...
            if(mBitmap != null){
                try {
                    ...
                    val f = File(externalCacheDir?.absoluteFile.toString() +
                            File.separator + "KidsDrawringApp_"+System.currentTimeMillis
                    ()/1000+".png")
